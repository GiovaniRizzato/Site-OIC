...
<script src="https://maps.googleapis.com/maps/api/js"></script>
    <script>
      function initialize() {
		var oicMark = new google.maps.LatLng(-25.549078, -54.518726);
		...
		content.push('Av. Felipe Wandscheer, 6945, Bairro Cognópolis<br />');
		content.push('Foz do Iguaçu / PR - Brasil • CEP: 85.856-530<br />');
